...
import com.example.smartmatch.ui.construction.collectioncontrol.NewCollectionSceneFragment
        ...
        safeLaunch {
            mViewModel.jumpToFragment.collect {
                when (it) {
                    ...
                    6 -> jumpToFragment(NewCollectionSceneFragment(1), "collectionControlFragment")
